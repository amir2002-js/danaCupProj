...
export default function LoginByEmail({emailVal , emailValidation , setEmailValidation , setEmailVal , setAlert , checkEmail , setCheckEmail , spiner , setSpiner}) {
	...
	return (
		<>
			...
			<div className="flex flex-col gap-9">
				...
				<EnterEmail emailVal={emailVal} setEmailVal={setEmailVal} emailValidation={emailValidation} setEmailValidation={setEmailValidation} checkEmail={checkEmail}/>
