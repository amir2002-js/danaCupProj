...
export default function BestSellerBook() {
	...
	return (
		<div className="flex *:flex-grow gap-5 flex-col md:flex-row mx-auto">
			{dataSeller.map((book) => (
				<div
					className="flex flex-col shadow-[0_0_10px_gray] dark:shadow-[0_0_10px_black] md:flex-row container max-w-[584px] gap-4 bg-white rounded-3xl dark:bg-slate-700 dark:text-white/20 py-5 items-center justify-between"
					key={book.id}
				>
					<div className=" flex ">
