    ...
    <div className="bg-white dark:text-white/80 dark:bg-slate-800  grid lg:grid-cols-2 max-lg:gap-5 grid-cols-1 rounded-xl p-4 shadow shadow-slate-400 justify-between items-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 items-center justify-items-center justify-center">
            ...
            <div className="flex flex-col gap-3 max-sm:text-center">
                ...
                برندن سَندرسون نویسنده اهل آمریکا است. او بیشتر به خاطر سری مه زاد و دست داشتن برای به اتمام رساندن کتاب خیال‌پردازی حماسی چرخ زمان، نوشته رابرت جوردن بعد از مرگ وی، شناخته شده‌است. در اوت سال ۲۰۱۰، ساندرسون اولین قسمت از مجموعه کتاب‌های ده‌گانه استورم‌لایت آرکایو، با نام طریق شاهان را منتشر کرد.
                </figcaption>
        ...
        <div className="grid grid-cols-3 justify-items-center gap-4 items-stretch">
            <img src="../../images/book1-bestWriterInWeak.png" width={"190px"} />
            <img src="../../images/book2-bestWriterInWeak.png" width={"190px"} />
            <img src="../../images/book3-bestWriterInWeak.png" width={"190px"} />
        </div>
    </div>
  )
}
